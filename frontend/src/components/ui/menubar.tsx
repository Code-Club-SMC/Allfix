...
function Menubar({
	...
	return (
		<MenubarPrimitive.Root
			data-slot="menubar"
			className={cn(
				"flex h-9 items-center gap-1 rounded-[4px] border p-1",
				className,
			)}
			{...props}
		/>
...
function MenubarTrigger({
	...
	return (
		<MenubarPrimitive.Trigger
			...
			className={cn(
				"flex items-center rounded-[4px] px-2 py-1 text-sm font-normal outline-hidden select-none hover:bg-muted aria-expanded:bg-muted",
				className,
			)}
			{...props}
		/>
