  ...
  <div className="mb-4 flex flex-col gap-3 rounded-lg border border-border bg-surface px-4 py-3 md:flex-row md:items-end md:justify-between">
    <div className="max-w-3xl space-y-1.5">
      <div className="flex items-center gap-1.5">
        <img src="/allfix-logo.jpeg" alt="Allfix" className="h-4 w-4 rounded object-cover" />
        <span className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground">Allfix</span>
      </div>
